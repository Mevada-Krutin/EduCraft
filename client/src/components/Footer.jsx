...
import { Github, Twitter, Linkedin, Mail, BookOpen, Box, Shield, Zap, Globe, Cpu, Activity, Database } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-16 mb-20">
          ...
          <div className="xl:col-span-4 space-y-8">
            ...
            <div className="flex gap-4">
                {[Twitter, Github, Linkedin, Mail].map((Icon, i) => (
                    <a key={i} href="#" className="w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-text-muted hover:text-primary hover:border-primary/40 hover:bg-slate-50 transition-all group/icon shadow-sm">
          ...
          <div className="xl:col-span-2 space-y-8">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-text-primary flex items-center gap-3">
                <div className="w-1 h-3 bg-primary rounded-full shadow-[0_0_8px_var(--primary)]"></div> Core Links
            </h4>
          ...
          <div className="xl:col-span-2 space-y-8">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-text-primary flex items-center gap-3">
                <div className="w-1 h-3 bg-secondary rounded-full shadow-[0_0_8px_var(--secondary)]"></div> Protocols
            </h4>
            <ul className="flex flex-col gap-4">
               {[
